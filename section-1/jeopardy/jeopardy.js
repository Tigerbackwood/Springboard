...
//    ...
//  ]
$('body').prepend('<table id="board"><thead></tHead><tbody></tbody></table>');
$('table').append('<button id="reset">Reset</button>')
let categories = [];
...
async function getCategoryIds() {
    ...
    let categoryID = response.data.map(catId => catId.id);
