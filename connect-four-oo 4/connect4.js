...
class Game {
  ...
  init() {
    ...
    this.button.addEventListener('click', (function(e) {
      ...
      this.width = parseInt(document.querySelector('#width').value);
      this.height = parseInt(document.querySelector('#height').value);
  ...
  for (let y = 0; y < this.height; y++) {
    for (let x = 0; x < this.width; x++) {
      ...
      if (bound(horiz) || bound(vert) || bound(diagDR) || bound(diagDL)) {
        return true;
      }
    }
  }
